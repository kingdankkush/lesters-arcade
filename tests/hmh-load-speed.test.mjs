...
test('WO-36 index boots through optimized dist bundle with first-screen preload hints', () => {
  ...
  assert.equal(index.includes('src="./dist/main.js?v=hmh-world-polish-20260911"'), true);
  assert.equal(index.includes('rel="modulepreload" href="./dist/main.js?v=hmh-world-polish-20260911"'), true);
  ...
  assert.equal(sw.includes('lesters-arcade-v34-hmh-world-polish'), true);
});
