...
test('WO-36 index boots through optimized dist bundle with first-screen preload hints', () => {
  ...
  assert.equal(index.includes('src="./dist/main.js?v=hmh-aaa-cycle-077-textured-heroes"'), true);
  assert.equal(index.includes('rel="modulepreload" href="./dist/main.js?v=hmh-aaa-cycle-077-textured-heroes"'), true);
  ...
  assert.equal(sw.includes('lesters-arcade-v29-hmh-textured-heroes'), true);
});
