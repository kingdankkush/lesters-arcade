...
test('WO-36 index boots through optimized dist bundle with first-screen preload hints', () => {
  ...
  assert.equal(index.includes('src="./dist/main.js?v=hmh-jul11-responsive-levelup-v36"'), true);
  assert.equal(index.includes('rel="modulepreload" href="./dist/main.js?v=hmh-jul11-responsive-levelup-v36"'), true);
  ...
  assert.equal(sw.includes('v3-responsive-levelup-v29'), true);
});
