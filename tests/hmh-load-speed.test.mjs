...
test('WO-36 index boots through optimized dist bundle with first-screen preload hints', () => {
  ...
  assert.equal(index.includes('src="./dist/main.js?v=arcade-discovery-20260914"'), true);
  assert.equal(index.includes('rel="modulepreload" href="./dist/main.js?v=arcade-discovery-20260914"'), true);
  assert.equal(index.includes('arcade-splash-poster.jpg'), true);
  ...
  assert.equal(sw.includes('lesters-arcade-v56-version-column'), true);
});
