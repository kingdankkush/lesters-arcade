...
test('WO-36 index boots through optimized dist bundle with first-screen preload hints', () => {
  ...
  assert.equal(index.includes('src="./dist/main.js?v=cabinet-leaderboard-v20"'), true);
  assert.equal(index.includes('rel="modulepreload" href="./dist/main.js?v=cabinet-leaderboard-v20"'), true);
  ...
  assert.equal(sw.includes('v2-dist-bundle'), true);
});
