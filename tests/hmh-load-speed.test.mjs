...
test('WO-36 index boots through optimized dist bundle with first-screen preload hints', () => {
  ...
  assert.equal(index.includes('src="./dist/main.js?v=hmh-jul10-runtime-stability-v35"'), true);
  assert.equal(index.includes('rel="modulepreload" href="./dist/main.js?v=hmh-jul10-runtime-stability-v35"'), true);
  ...
  assert.equal(sw.includes('v3-runtime-stability-v28'), true);
});
