...
test('WO-36 index boots through optimized dist bundle with first-screen preload hints', () => {
  ...
  assert.equal(index.includes('src="./dist/main.js?v=hmh-package-20260912"'), true);
  assert.equal(index.includes('rel="modulepreload" href="./dist/main.js?v=hmh-package-20260912"'), true);
  ...
  assert.equal(sw.includes('lesters-arcade-v37-chikun-afterlight'), true);
});
