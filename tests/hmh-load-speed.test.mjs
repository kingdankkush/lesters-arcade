...
test('WO-36 index boots through optimized dist bundle with first-screen preload hints', () => {
  ...
  assert.equal(index.includes('src="./dist/main.js?v=hmh-jul12-world-v3-v37"'), true);
  assert.equal(index.includes('rel="modulepreload" href="./dist/main.js?v=hmh-jul12-world-v3-v37"'), true);
  ...
  assert.equal(sw.includes('lesters-arcade-v3-world-v3-v30'), true);
});
