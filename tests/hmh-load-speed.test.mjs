...
test('WO-36 index boots through optimized dist bundle with first-screen preload hints', () => {
  ...
  assert.equal(index.includes('src="./dist/main.js?v=hmh-jul9-terrain-v28"'), true);
  assert.equal(index.includes('rel="modulepreload" href="./dist/main.js?v=hmh-jul9-terrain-v28"'), true);
