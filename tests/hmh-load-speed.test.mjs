...
test('WO-36 index boots through optimized dist bundle with first-screen preload hints', () => {
  ...
  assert.equal(index.includes('src="./dist/main.js?v=hmh-aaa-cycle-072-visual-facelift"'), true);
  assert.equal(index.includes('rel="modulepreload" href="./dist/main.js?v=hmh-aaa-cycle-072-visual-facelift"'), true);
  ...
  assert.equal(sw.includes('lesters-arcade-v25-hmh-visual-facelift'), true);
});
