...
test('WO-36 index boots through optimized dist bundle with first-screen preload hints', () => {
  ...
  assert.equal(index.includes('src="./dist/main.js?v=combined-gameplay-20260914"'), true);
  assert.equal(index.includes('rel="modulepreload" href="./dist/main.js?v=combined-gameplay-20260914"'), true);
  ...
  assert.equal(sw.includes('lesters-arcade-v47-combined-gameplay'), true);
});
