...
test('WO-36 index boots through optimized dist bundle with first-screen preload hints', () => {
  ...
  assert.equal(index.includes('src="./dist/main.js?v=hmh-ship-polish-v42"'), true);
  assert.equal(index.includes('rel="modulepreload" href="./dist/main.js?v=hmh-ship-polish-v42"'), true);
  ...
  assert.equal(sw.includes('lesters-arcade-v3-ship-polish-v42'), true);
});
