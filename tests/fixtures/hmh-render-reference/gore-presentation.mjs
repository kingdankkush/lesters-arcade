// Verbatim copy of the 1.8.1 release (60ea173a) apps/hmh-reboot/src/gore-presentation.mjs, kept as the
// reference for tests/hmh-render-alloc.test.mjs (gore draw calls and pool state). Do not edit.
import { feedbackUnit } from '../../../apps/hmh-reboot/src/deterministic-hash.mjs';
