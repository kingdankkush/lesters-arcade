// Verbatim copy of the 1.8.1 release (60ea173a) apps/hmh-reboot/src/enemy-roster-atlas.mjs, kept as the
// reference for tests/hmh-render-alloc.test.mjs (frame lookups, poses, display tint). Do not edit.
/**
