...
test('WO-76 declares exactly ten approval-gated anchor slots in the required order', () => {
  ...
  assert.equal(HMH_ANCHOR_SET_STATUS.status, 'HALT_AWAITING_JUSTIN_ANCHOR_APPROVAL');
...
test('WO-76 draft docs exist but keep anchors unapproved until Justin picks winners', () => {
