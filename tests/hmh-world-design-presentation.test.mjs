...
import * as worldDesignLife from '../apps/hmh-reboot/src/world-design-life.mjs';
const { worldDesignPropPresentation, prepareWorldDesignEnemyPose } = worldDesignLife;
...
// Owner decision (2026-09-25): HMH has no footstep sounds. The surface
// selector never had a runtime caller and is gone.
test('no footstep selector is exported for the runtime to call',()=>{
  assert.equal('worldDesignFootstep' in worldDesignLife,false);
});
