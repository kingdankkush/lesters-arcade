...
const row=(id,extras={})=>({sessionId:id,gameId:'chikun',wallet:'0xabc',mode:'ranked',score:50,runStats:{evidenceVersion:'chikun-flap-evidence-v5',coinsCollected:3,survivalTicks:120,survivalTime:2,...extras}});
