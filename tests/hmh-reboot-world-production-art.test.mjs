...
test('world art contract is production, layered, and never gains gameplay authority', () => {
  ...
  assert.deepEqual(WORLD_PRODUCTION_ART.layers, ['terrain', 'groundDetails', 'routes', 'surfaces', 'details', 'blockers', 'townBlockers', 'landmarks', 'interactions', 'particles', 'lighting', 'vignette']);
