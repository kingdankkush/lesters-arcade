...
export const DROP_TABLES = Object.freeze({
  ...
  elite: Object.freeze([
    { id: 'xp-gem', weight: 35 },
    { id: 'ltc-cache', weight: 25 },
    { id: 'ammo-cache', weight: 15 },
    { id: 'heal-pack', weight: 10 },
  ...
  boss: Object.freeze([
    { id: 'xp-gem', weight: 15 },
    { id: 'ltc-cache', weight: 20 },
    { id: 'nuke-liquidation', weight: 15 },
    { id: 'berserk-candle', weight: 15 },
    { id: 'time-dilation', weight: 15 },
    { id: 'heal-pack', weight: 10 },
    { id: 'shield-cache', weight: 10 },
  ]),
});
