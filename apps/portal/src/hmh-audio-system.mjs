export const HMH_SFX_CUE_REGISTRY = Object.freeze({
  ...
  'powerup-expire': Object.freeze({ family: 'reward', priority: 2, cooldownMs: 300, tone: Object.freeze([784, 523, 392]), synth: 'sine', gainMul: 0.7, samplePreferred: true }),
  ...
  'combo-reset': Object.freeze({ family: 'damage', priority: 2, cooldownMs: 181, tone: Object.freeze([330, 165]), synth: 'square', gainMul: 0.58, samplePreferred: true }),
  'combo-milestone': Object.freeze({ family: 'reward', priority: 4, cooldownMs: 109, tone: Object.freeze([440, 660, 880, 1320]), synth: 'triangle', gainMul: 0.9, samplePreferred: true }),
  'combo-boss-threshold': Object.freeze({ family: 'boss', priority: 5, cooldownMs: 503, tone: Object.freeze([110, 220, 440, 880, 1320]), synth: 'square', gainMul: 1.12, samplePreferred: true }),
