...
export const SCENE_TEMPLATES = Object.freeze({
  ...
  tree_grove: Object.freeze({
    ...
    slots: [
      { ...A('curated/juniper-tree-idle-00', 'tree', { radius: 0.58 }), place: 'anchor', count: 1 },
      { ...A('curated/cottonwood-tree-idle-00', 'tree', { radius: 0.62 }), place: 'scatter', count: 1 },
      { ...A('curated/forest-boundary-a-03', 'tree', { radius: 0.72 }), place: 'pathEdge', spacing: 2, count: 2 },
  ...
  authored_forest_trail_edge: Object.freeze({
    ...
    slots: [
      { ...A('curated/forest-boundary-a-03', 'tree', { radius: 0.72 }), place: 'pathEdge', spacing: 2, count: 3 },
      { ...A('curated/juniper-tree-idle-00', 'tree', { radius: 0.58 }), place: 'scatter', count: 1 },
  ...
  crypto_dry_forest_cave: Object.freeze({
    ...
    slots: [
      { ...A('crypto/canyon-cliff-edge', 'wall', { radius: 0.8 }), place: 'anchor', count: 1 },
      { ...A('curated/forest-boundary-b-09', 'tree', { radius: 0.72 }), place: 'pathEdge', spacing: 2, count: 3 },
      { ...A('curated/dead-tree-idle-00', 'tree', { radius: 0.52 }), place: 'scatter', count: 1 },
      { ...A('nature/fallen-log', 'smallprop', { radius: 0.45 }), place: 'scatter', count: 2 },
      { ...A('nature/bush', 'smallprop', { solid: false, radius: 0 }), place: 'scatter', count: 3 },
  ...
  sketch_lake_pond_edge: Object.freeze({
    ...
    slots: [
      ...
      { ...A('level1-final-animated/oasis-reeds-sway', 'water-strip', { solid: false, radius: 0 }), place: 'pathEdge', spacing: 2, count: 3 },
  ...
  sketch_town_boundary_fronts: Object.freeze({
    ...
    slots: [
      { ...A('level1-final-animated/town-bank-flicker', 'building', { radius: 0.8 }), place: 'anchor', count: 1 },
  ...
  sketch_farm_silo_yard: Object.freeze({
    ...
    slots: [
      ...
      { ...A('construct/fence-segment', 'fence', { radius: 0.32 }), place: 'pathEdge', spacing: 1, count: 5 },
      { ...A('level1-polish/farmhouse-porch', 'building', { radius: 0.7 }), place: 'scatter', count: 1 },
      { ...A('level1-final-animated/wheat-patch-wind', 'crop', { solid: false, radius: 0 }), place: 'scatter', count: 2 },
  ...
  sketch_forest_boundary_wall: Object.freeze({
    ...
    slots: [
      { ...A('level1-final-animated/forest-wall-pine-sway', 'tree', { radius: 0.72 }), place: 'pathEdge', spacing: 2, count: 4 },
