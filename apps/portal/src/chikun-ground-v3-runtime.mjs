import {courseObstacles,groundPickups,distanceAtTick,speedAtTick,courseRegion,courseTerrain,GROUND_Y} from './chikun-ground-v3-course.mjs';
import {obstacleClearance} from './chikun-obstacles.mjs';
export const GROUND_EVIDENCE='chikun-flap-evidence-v3';
