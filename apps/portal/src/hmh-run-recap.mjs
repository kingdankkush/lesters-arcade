...
export const UPGRADE_LABELS = Object.freeze({
  'proof-of-work': 'Damage',
  'diamond-hands': 'Max Health',
  'gas-optimization': 'Dash Recharge',
  'cold-storage': 'Extra Grenade',
  'block-reward': 'Score & Magazine',
  'validator-training': 'XP Gain',
  'compound-interest': 'Damage Mastery',
  'precision-ledger': 'Critical Chance',
  'hard-fork-rounds': 'Critical Damage',
  'hot-wallet': 'Movement Speed',
  'layer-two': 'Speed Mastery',
  'hardened-wallet': 'Health Mastery',
  'ledger-conductivity': 'Arc Range',
  'ledger-voltage': 'Arc Damage',
  'ledger-reconciliation': 'Energy Reserves',
  'proof-of-network': 'Overcharged Pulse',
  'burner-liquidity': 'Fuel Capacity',
  'burner-volatility': 'Burn Damage',
  'burner-contagion': 'Flame Reach',
  'total-selloff': 'Flame Surge',
  'standard-reach': 'Melee Reach',
  'standard-force': 'Melee Damage',
  'standard-tempo': 'Attack Speed',
  'canonical-fork': 'Power Strike',
});
