...
const UPGRADE_PRESENTATION_COPY = Object.freeze({
  'damage-alpha': Object.freeze({ title: 'Damage', description: 'Increase the damage dealt by every weapon hit.' }),
  'reload-hands': Object.freeze({ title: 'Reload Speed', description: 'Reload every weapon faster after its magazine runs dry.' }),
  'move-speed': Object.freeze({ title: 'Movement Speed', description: 'Increase movement speed for safer routes and faster escapes.' }),
  'magazine-size': Object.freeze({ title: 'Magazine Size', description: 'Carry more rounds in each magazine before reloading.' }),
  'rate-of-fire': Object.freeze({ title: 'Fire Rate', description: 'Increase weapon fire rate while preserving readable recoil.' }),
  'pickup-radius': Object.freeze({ title: 'Pickup Range', description: 'Collect XP shards from farther away.' }),
  'max-health': Object.freeze({ title: 'Max Health', description: 'Increase maximum health and extend your survival window.' }),
  'critical-chance': Object.freeze({ title: 'Critical Chance', description: 'Increase the chance that any weapon hit becomes critical.' }),
  'critical-damage': Object.freeze({ title: 'Critical Damage', description: 'Increase the damage multiplier applied to critical hits.' }),
  'projectile-speed': Object.freeze({ title: 'Bullet Speed', description: 'Make projectiles travel faster and reach moving targets sooner.' }),
  pierce: Object.freeze({ title: 'Piercing Shots', description: 'Allow projectiles to pass through additional enemies.' }),
  'spread-control': Object.freeze({ title: 'Accuracy', description: 'Tighten weapon spread for more accurate ranged fire.' }),
  'grenade-capacity': Object.freeze({ title: 'Grenade Capacity', description: 'Carry one additional grenade before needing a refill.' }),
  armor: Object.freeze({ title: 'Armor', description: 'Reduce incoming damage from enemies, hazards, and bosses.' }),
  'grenade-damage': Object.freeze({ title: 'Grenade Damage', description: 'Increase the damage dealt by every grenade explosion.' }),
  'grenade-radius': Object.freeze({ title: 'Blast Radius', description: 'Increase the area covered by each grenade explosion.' }),
  'xp-gain': Object.freeze({ title: 'XP Gain', description: 'Gain more experience from kills and XP pickups.' }),
  'power-up-luck': Object.freeze({ title: 'Drop Luck', description: 'Improve the chance of finding higher-rarity power-ups.' }),
  'dash-cooldown': Object.freeze({ title: 'Dash Recharge', description: 'Reduce dash recovery time so the next dodge is ready sooner.' }),
  'launcher-rig': Object.freeze({ title: 'Grenade Launcher', description: 'Convert grenades to a faster, flatter long-range launcher arc.' }),
  'dash-distance': Object.freeze({ title: 'Dash Distance', description: 'Increase dash distance to clear wider danger zones.' }),
  'health-regen': Object.freeze({ title: 'Health Regeneration', description: 'Regenerate health gradually while the run continues.' }),
  'coin-value': Object.freeze({ title: 'Score Bonus', description: 'Increase score bonuses from eligible score pickups. Silver drops have no score value.' }),
  'combo-retention': Object.freeze({ title: 'Combo Duration', description: 'Keep the combo meter active longer between enemy kills.' }),
  'homing-cluster': Object.freeze({ title: 'Homing Grenades', description: 'Convert grenades into seekers that target the largest enemy cluster.' }),
  'block-buster': Object.freeze({ title: 'Heavy Grenades', description: 'Convert grenades into slower heavy blasts with a larger impact.' }),
  'evolve-settler-rail': Object.freeze({ title: 'Piercing Pistol', description: 'Evolve the pistol into piercing Litecoin rail shots.' }),
  'evolve-hashstorm-overdrive': Object.freeze({ title: 'Machine Gun Overdrive', description: 'Evolve automatic fire into a powerful, readable projectile storm.' }),
  'evolve-crit-candle': Object.freeze({ title: 'Railgun Critical Chain', description: 'Evolve rail critical hits into golden score-building chains.' }),
  'evolve-crypto-bomb-orbit': Object.freeze({ title: 'Orbiting Grenades', description: 'Evolve grenades into orbiting protection around your hero.' }),
  revive: Object.freeze({ title: 'Second Chance', description: 'Survive one killing blow and return with emergency health.' }),
});
