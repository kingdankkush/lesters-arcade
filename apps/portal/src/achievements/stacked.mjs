...
const specs = [
  ...
  { id: 'stacked-first-spin', title: 'First Spin', tier: 'bronze', category: 'spin', description: 'Locked a piece with a spin in a Ranked run.', rule: best('spins', 1) },
  ...
  { id: 'stacked-combo-2', title: 'Chain Starter', tier: 'bronze', category: 'combo', description: 'Reached a combo of 2 (3 clearing pieces in a row) in one Ranked run.', rule: best('maxCombo', 2) },
  ...
  { id: 'stacked-combo-5', title: 'Five-Link Chain', tier: 'silver', category: 'combo', description: 'Reached a combo of 5 (6 clearing pieces in a row) in one Ranked run.', rule: best('maxCombo', 5) },
  { id: 'stacked-b2b-2', title: 'Back-to-Back', tier: 'silver', category: 'back-to-back', description: 'Made two difficult clears (Halvings or spin clears) back to back.', rule: best('maxBackToBack', 2) },
  ...
  { id: 'stacked-combo-10', title: 'Ten-Link Chain', tier: 'gold', category: 'combo', description: 'Reached a combo of 10 (11 clearing pieces in a row) in one Ranked run.', rule: best('maxCombo', 10) },
  { id: 'stacked-b2b-5', title: 'Difficulty Spike', tier: 'gold', category: 'back-to-back', description: 'Made 5 difficult clears (Halvings or spin clears) back to back.', rule: best('maxBackToBack', 5) },
  ...
  { id: 'stacked-b2b-10', title: 'Unbroken Chain', tier: 'platinum', category: 'back-to-back', nft: true, description: 'Made 10 difficult clears (Halvings or spin clears) back to back.', rule: best('maxBackToBack', 10) },
];
