...
export const HMH_PLAYABLE_CHARACTER_STAT_IDENTITIES = Object.freeze({
  'lit-commando': Object.freeze({
    ...
    bio: 'Battle-worn commando with a dark mohawk and olive tactical gear. More HP, armor, and damage — a touch slower. Walks straight into the panic with hard money on his side.',
  ...
  'lit-valkyrie': Object.freeze({
    ...
    bio: 'Battle-ready survivor with long blonde hair and rugged combat gear. Faster movement, higher fire-rate and crit chance — but more fragile. Darts through the panic and punishes mistakes.',
  ...
  'lester-original': Object.freeze({
    ...
    bio: 'The original arcade commando with a blue coin head and olive combat gear. Balanced stats across the board. Unlock after 10 Ranked Hard Money Heroes matches; legacy Level 1 clear profiles keep him.',
  ...
  lilly: Object.freeze({
    ...
    bio: 'Tactical veteran with teal hair and a long coat over armored combat gear. Unlock after 20 Ranked Hard Money Heroes matches.',
