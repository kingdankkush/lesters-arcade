...
export const CABINET_MODE_SELECT_PRESENTATIONS = Object.freeze({
  ...
  chikun: Object.freeze({
    ...
    eyebrow: 'Selected Cabinet',
    copy: 'Choose Free Mode for endless guest practice or Play Ranked for a wallet-bound, replay-verified score recorded to your Lester’s Arcade profile and the Chikun’s Escape score boards.',
    artStatus: 'production',
