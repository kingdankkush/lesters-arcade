...
export const HARD_MONEY_HEROES_CANON = Object.freeze({
  ...
  levels: Object.freeze([
    Object.freeze({
      ...
      enemyTeaching: Object.freeze(['FUD Mine Zombies', 'Paper Hands', 'Rug Crawler Zombies', 'Honeypot Ambush Gunners', 'Gas-Tax Zombies', 'Slippage Skaters']),
    }),
    Object.freeze({
      id: 'the-tower',
      ...
      enemyTeaching: Object.freeze(['Sybil Gunner Cells', 'Phishing Anglers', 'MEV Reapers', 'Honeypot Ambush Gunners']),
    }),
    Object.freeze({
      id: 'the-getaway',
      ...
      enemyTeaching: Object.freeze(['Slippage Skaters', 'Paper Hands', 'Honeypot Ambush Gunners', 'MEV Reapers', 'Liquidation Riot Zombies', 'Gas-Tax Zombies', 'Sybil Gunner Cells']),
    }),
  ]),
...
export const CABINET_MODE_SELECT_PRESENTATIONS = Object.freeze({
  ...
  chikun: Object.freeze({
    ...
    eyebrow: 'Selected Cabinet',
    copy: 'Choose Free Mode to practice without a wallet, or Play Ranked for a wallet-bound, replay-verified score recorded to your Lester’s Arcade profile and the Chikun’s Escape score boards.',
    artStatus: 'production',
    backgroundAsset: './assets/generated/chikun-mode-select/chikuns-escape-ranked-mode.webp',
...
export const HARD_MONEY_HEROES_ASSET_MANIFEST = Object.freeze({
  ...
  enemies: Object.freeze({
    ...
    gasBeast: Object.freeze({
      id: 'gas-beast',
      title: 'Gas-Tax Zombie Brute',
      art: hardMoneyEnemyArt('gas-beast', 'Gas-Tax Zombie Brute'),
...
const ACHIEVEMENT_DEFINITIONS = Object.freeze([
  ...
  defineAchievement({ key: 'GAS_BEAST_HUNTER', id: 'gas-beast-hunter', title: 'Gas-Tax Hunter', description: 'Defeated 50 Gas-Tax Zombie Brutes across official runs.', tier: 'silver', difficulty: 'medium', unlockType: 'enemy-hunt', icon: '☣', requirement: { enemyId: 'gas-beast', cumulativeKills: 50 } }),
  defineAchievement({ key: 'GOBLIN_CLEANUP', id: 'goblin-cleanup', title: 'Wasteland Cleanup', description: 'Defeated 75 FUD Mine Zombies, Paper Hands, or Rug Crawler Zombies.', tier: 'silver', difficulty: 'medium', unlockType: 'enemy-hunt', icon: '☠', requirement: { family: 'goblin', cumulativeKills: 75 } }),
  defineAchievement({ key: 'DRONE_SWATTER', id: 'drone-swatter', title: 'Sybil Breaker', description: 'Defeated 60 Sybil Gunners or coordinated cell enemies.', tier: 'silver', difficulty: 'medium', unlockType: 'enemy-hunt', icon: '✦', requirement: { family: 'drone', cumulativeKills: 60 } }),
...
export const LESTER_BLASTER_CHARACTER_ROSTER = Object.freeze([
  ...
  Object.freeze({
    ...
    spriteSheet: './assets/generated/hmh-animated-roster-atlas/portraits/lester.webp',
    portraitAsset: './assets/generated/hmh-animated-roster-atlas/portraits/lester.webp',
    legacyId: 'lester',
  ...
  Object.freeze({
    ...
    spriteSheet: './assets/generated/hmh-animated-roster-atlas/portraits/lilly.webp',
    portraitAsset: './assets/generated/hmh-animated-roster-atlas/portraits/lilly.webp',
    legacyId: 'lilly',
...
export const LESTER_BLASTER_ENVIRONMENTS = Object.freeze([
  Object.freeze({
    ...
    hazards: Object.freeze(['steam grates', 'flickering scam signs', 'cheap platforms yanked by Rug Crawler Zombies']),
...
export const LESTER_BLASTER_ENEMY_CATALOG = Object.freeze([
  Object.freeze({ id: 'fud-goblin', title: 'FUD Mine Zombie', class: 'zombie-lobber', runtimeActorKey: 'scorpion-ambusher', baseHealth: 7, damage: 7, speed: 1.8, score: 80, spawnAfterSeconds: 0, aiArchetype: 'swarm-shambler', districtFamilies: Object.freeze(['desert_approach', 'ghost_town', 'country_road', 'residential_edge']), animationStates: Object.freeze(['shamble', 'lob-sell', 'attack-tell', 'hit', 'red-candle-pop']), attackPatterns: Object.freeze(['slow-sell-arc', 'swarm-body-block']), deathEffect: 'puff of red candle smoke + always-on silver impact sparks', tells: 'mouth opens with SELL bubble wind-up' }),
  Object.freeze({ id: 'gas-fee-wisp', title: 'Gas-Tax Zombie', class: 'quarantined-zombie-hazard', runtimeActorKey: 'wild-boar', baseHealth: 10, damage: 8, speed: 2.2, score: 140, spawnAfterSeconds: 9999, aiArchetype: 'hover-taxer', districtFamilies: Object.freeze([]), preferredRangeMode: 'ranged', artStatus: 'quarantined-until-bespoke-wisp-art-replaces-gas-beast-proxy', animationStates: Object.freeze(['float', 'tax-pulse', 'attack-tell', 'tar-drop', 'hit', 'pop']), attackPatterns: Object.freeze(['resource-tax', 'sticky-tar-puddle']), deathEffect: 'orange flame pop + pump handle fragments', tells: 'gas-pump body glows before taxing' }),
  ...
  Object.freeze({ id: 'fud-goblin-cave', title: 'Cave FUD Zombie', class: 'cave-zombie-lobber', runtimeActorKey: 'scorpion-ambusher', baseHealth: 9, damage: 8, speed: 2.05, score: 110, spawnAfterSeconds: 45, aiArchetype: 'cave-lob-scatter', districtFamilies: Object.freeze(['country_road', 'dry_forest_cave']), poiIds: Object.freeze(['dry-forest-cave']), preferredRangeMode: 'ranged', enemyKey: 'trenchDegen', animationStates: Object.freeze(['idle', 'run', 'attack-tell', 'attack', 'hit', 'death']), attackPatterns: Object.freeze(['torch-lob', 'cave-mouth-scatter']), deathEffect: 'torch ash burst + cave dust puff', tells: 'bright torch-up silhouette before the cave toss' }),
  ...
  Object.freeze({ id: 'gas-beast', title: 'Gas-Tax Zombie Brute', class: 'armored-zombie-bruiser', runtimeActorKey: 'wild-boar', baseHealth: 32, damage: 16, speed: 0.95, score: 340, spawnAfterSeconds: 115, aiArchetype: 'gas-cloud-area-denial', districtFamilies: Object.freeze(['inner_city', 'residential_edge']), preferredRangeMode: 'melee', enemyKey: 'gasBeast', animationStates: Object.freeze(['idle', 'walk', 'run', 'jump', 'attack-tell', 'attack', 'hit', 'death']), attackPatterns: Object.freeze(['gas-tax-pulse', 'slow-claw-swipe', 'short-hop-body-check']), deathEffect: 'orange/blue gas burst + ETH fee shards', tells: 'chest vents glow orange before gas pulse' }),
  Object.freeze({ id: 'sybil-drone', title: 'Sybil Gunner Cell', class: 'formation-ranged-human', runtimeActorKey: 'sybil-drone', baseHealth: 9, damage: 10, speed: 2.4, score: 150, spawnAfterSeconds: 80, aiArchetype: 'parent-drone-formation', districtFamilies: Object.freeze(['desert_approach', 'inner_city']), preferredRangeMode: 'ranged', animationStates: Object.freeze(['idle', 'walk', 'attack-tell', 'attack', 'scatter', 'hit', 'death']), attackPatterns: Object.freeze(['formation-burst', 'cell-scatter']), deathEffect: 'mask shards + cyan weapon sparks', tells: 'blank wallet mask flashes a red target dot before the burst' }),
  Object.freeze({ id: 'rug-rat', title: 'Rug Trapper Zombie', class: 'zombie-disruptor', runtimeActorKey: 'rattlesnake', baseHealth: 8, damage: 7, speed: 3.3, score: 130, spawnAfterSeconds: 70, aiArchetype: 'platform-yanker', districtFamilies: Object.freeze(['ghost_town', 'country_road']), poiIds: Object.freeze(['rugpull-gulch', 'rugpull-gulch-boss-yard']), preferredRangeMode: 'melee', animationStates: Object.freeze(['idle', 'walk', 'run', 'attack-tell', 'attack', 'hit', 'death', 'spawn-in']), attackPatterns: Object.freeze(['platform-yank', 'low-dash-knockback']), deathEffect: 'torn carpet scraps + red dust puff', tells: 'steel jaw trap opens before the low dash' }),
  Object.freeze({ id: 'honeypot-turret', title: 'Honeypot Ambush Gunner', class: 'stationary-ranged-human', runtimeActorKey: 'sybil-drone', baseHealth: 18, damage: 13, speed: 0, score: 220, spawnAfterSeconds: 90, aiArchetype: 'loot-bait-trap', districtFamilies: Object.freeze(['country_road', 'inner_city']), preferredRangeMode: 'ranged', animationStates: Object.freeze(['crouch-bait', 'rise', 'attack-tell', 'burst-fire', 'hit', 'collapse', 'death']), attackPatterns: Object.freeze(['short-range-spread', 'crouched-burst']), deathEffect: 'mask shards + brass sparks + blue reveal pulse', tells: 'the crouched gunner raises a target laser before the ambush burst' }),
  Object.freeze({ id: 'coyote-pack-runner', title: 'Road Zombie Runner', class: 'zombie-pack-rusher', runtimeActorKey: 'coyote-pack-runner', baseHealth: 18, damage: 13, speed: 3.5, score: 235, spawnAfterSeconds: 90, aiArchetype: 'pack-feint-lunge', districtFamilies: Object.freeze(['country_road', 'dry_forest_cave']), poiIds: Object.freeze(['dry-forest-cave', 'crossroads-trading-post']), preferredRangeMode: 'melee', animationStates: Object.freeze(['idle', 'run', 'attack-tell', 'attack', 'hit', 'death']), attackPatterns: Object.freeze(['pack-feint-lunge', 'side-lane-collapse']), deathEffect: 'dust skid + torn jacket scraps', tells: 'shoulders coil low before the zombie pack leap' }),
  Object.freeze({ id: 'wild-boar', title: 'Armored Zombie Brute', class: 'armored-zombie-charger', runtimeActorKey: 'wild-boar', baseHealth: 24, damage: 15, speed: 3.1, score: 275, spawnAfterSeconds: 105, aiArchetype: 'straight-line-charge', districtFamilies: Object.freeze(['country_road', 'dry_forest_cave']), poiIds: Object.freeze(['dry-forest-cave', 'crossroads-trading-post']), preferredRangeMode: 'melee', animationStates: Object.freeze(['idle', 'run', 'attack-tell', 'attack', 'hit', 'death']), attackPatterns: Object.freeze(['boot-scrape-charge', 'recovery-skid-turn']), deathEffect: 'dirt spray + rusted armor shards', tells: 'heavy boot scrapes dirt before the armored charge commits' }),
  Object.freeze({ id: 'buzzard', title: 'Wasteland Raider Scout', class: 'ranged-human-scout', runtimeActorKey: 'buzzard', baseHealth: 14, damage: 10, speed: 2.7, score: 185, spawnAfterSeconds: 85, aiArchetype: 'circle-dive-harass', districtFamilies: Object.freeze(['desert_approach', 'oasis_lakeside']), poiIds: Object.freeze(['old-hashrate-camp', 'oasis-lakeside']), preferredRangeMode: 'ranged', animationStates: Object.freeze(['idle', 'strafe', 'attack-tell', 'attack', 'hit', 'death']), attackPatterns: Object.freeze(['scope-mark-shot', 'scout-relocate']), deathEffect: 'poncho scraps + rifle sparks + dust spiral', tells: 'cyan scope glint holds before the scout fires' }),
  Object.freeze({ id: 'rattlesnake', title: 'Zombie Trapper', class: 'zombie-trapper', runtimeActorKey: 'rattlesnake', baseHealth: 20, damage: 14, speed: 2.5, score: 255, spawnAfterSeconds: 100, aiArchetype: 'trap-feint-strike', districtFamilies: Object.freeze(['desert_approach', 'residential_edge', 'oasis_lakeside']), poiIds: Object.freeze(['oasis-lakeside', 'mesa-overlook']), preferredRangeMode: 'melee', animationStates: Object.freeze(['idle', 'walk', 'run', 'attack-tell', 'attack', 'hit', 'death', 'spawn-in']), attackPatterns: Object.freeze(['trap-lunge-strike', 'sand-recoil-reset']), deathEffect: 'sand plume + infected cyan mist flicker', tells: 'the trapper plants both boots, opens its steel jaw trap, and raises its cleaver before striking' }),
  Object.freeze({ id: 'scorpion-ambusher', title: 'Mine Zombie Ambusher', class: 'zombie-burrow-ambusher', runtimeActorKey: 'scorpion-ambusher', baseHealth: 22, damage: 15, speed: 2.4, score: 280, spawnAfterSeconds: 110, aiArchetype: 'burrow-tail-strike', districtFamilies: Object.freeze(['desert_approach', 'oasis_lakeside']), poiIds: Object.freeze(['old-hashrate-camp', 'oasis-lakeside']), preferredRangeMode: 'melee', animationStates: Object.freeze(['idle', 'burrow', 'attack-tell', 'attack', 'hit', 'death']), attackPatterns: Object.freeze(['sand-burrow-pop', 'pickaxe-overhead-strike']), deathEffect: 'sand plume + hardhat lamp sparks', tells: 'a cyan hardhat lamp rises from the sand before the pickaxe strike' }),
...
export const HMH_LEVEL_ONE_BOSS_ROSTER = Object.freeze([
  ...
  Object.freeze({ role: 'mini-boss', zoneId: 'warehouse-gas-station-yard', enemyId: 'gas-beast', title: 'Gas-Tax Zombie Brute', humanoid: true, runtimeActorKey: 'wild-boar', read: 'large armored zombie tank for warehouse/gas-station pressure' }),
...
export function chooseEnemySpawn({ elapsedSeconds = 0, seed = 0, districtFamily = null, activePoiId = null, forceEnemyId = null, spawnLaneRole = null } = {}) {
  ...
  const laneRoleApplied = !forcedEnemy && lanePool.length > 0;
