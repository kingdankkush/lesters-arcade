...
export function resolveProjectilePath({ projectile, targets = [], blockers = [], broadphase = null } = {}) {
  ...
  return Object.freeze({
    ...
    coverHit: resolution.cover ? Object.freeze({ blockerId: resolution.cover.blockerId, time: resolution.cover.time, point: Object.freeze({ ...resolution.cover.point }) }) : null,
