...
export const FABLE_MARKDOWN_CROSSWALK = Object.freeze({
  ...
  remainingImplementableWaves: Object.freeze([
    Object.freeze({ id: 'Wave 2 / EPIC 1', priority: 'P0', title: 'endless survival economy and difficulty loop', status: 'remaining-major-work', notes: 'Requires XP curve rebalance to 60-80 levels, endless escalation director, 80-level draft depth, game-feel physics, and integrity retune as one coordinated balance wave.' }),
