...
function stateCoverage(animations = {}, state) {
  const match = framesForState(animations, state);
  if (!match || match.directionCount <= 0) {
    return Object.freeze({ state, status: 'missing', matchedState: null, directionCount: 0, directions: Object.freeze([]), minFrames: 0, maxFrames: 0 });
  }
