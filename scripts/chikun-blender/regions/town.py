...
def ground(ctx):
    ...
    cob = [(0.25, '#6d665a'), (0.55, '#827a6b'), (0.85, '#958c7b')]
    mat = groundkit.ground_material('town_ground', [(0.3, '#7a7263'), (0.6, '#8b8271'), (0.9, '#9c927f')], [
        (598, 612, [(0.3, '#8e8676'), (0.6, '#a09684'), (0.9, '#b0a693')], 1.0),
        (612, 640, cob, 1.0),
        (640, 668, [(0.25, '#5f594f'), (0.55, '#716a5d'), (0.85, '#837b6c')], 1.0),
        (668, 693, [(0.25, '#6a6356'), (0.55, '#7c7466'), (0.85, '#8d8475')], 1.0),
    ], scale=0.35, stripes=[(612, 640, 70.0, '#4e483f', 0.55), (640, 668, 60.0, '#46413a', 0.6), (668, 693, 40.0, '#514b42', 0.5), (646, 650, 26.0, '#2f2c28', 0.8), (658, 661, 26.0, '#2f2c28', 0.8)])
