...
const NODE_CHECK_FILES = [
  ...
  'apps/chikun/src/obstacle-art.mjs',
  'apps/chikun/src/obstacle-catalog.mjs',
  'scripts/build-chikun-hitbox-templates.mjs',
  'scripts/chikun-blender/chikun-obstacle-layout-dump.mjs',
  'tests/chikun-obstacle-coverage.mjs',
  'tests/chikun-obstacle-art.test.mjs',
...
const PY_COMPILE_FILES = [
  ...
  'scripts/chikun-blender/build-chikun-obstacles.py',
  'scripts/chikun-blender/obstacles/__init__.py',
  'scripts/chikun-blender/obstacles/rig.py',
  'scripts/chikun-blender/obstacles/geo.py',
  'scripts/chikun-blender/obstacles/mats.py',
  'scripts/chikun-blender/obstacles/fit.py',
  'scripts/chikun-blender/obstacles/props.py',
  'scripts/chikun-blender/obstacles/trees.py',
  'scripts/chikun-blender/obstacles/creatures.py',
  'scripts/chikun-blender/obstacles/machines.py',
  'scripts/chikun-blender/obstacles/structures.py',
  'scripts/chikun-blender/obstacles/terrain.py',
  'scripts/chikun-blender/obstacles/registry.py',
  'scripts/build-chikun-obstacle-pack.py',
  'scripts/build-chikun-obstacle-review.py',
