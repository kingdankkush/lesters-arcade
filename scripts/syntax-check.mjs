...
const NODE_CHECK_FILES = [
  ...
  'apps/chikun/src/scene-bus.mjs',
  'apps/chikun/src/light-rig.mjs',
  'apps/chikun/src/device-blit.mjs',
  'apps/chikun/src/art-loader.mjs',
  'apps/chikun/src/scenery-catalog.mjs',
  'apps/chikun/src/parallax.mjs',
  'apps/chikun/src/atmosphere.mjs',
  'apps/chikun/src/painters.mjs',
  'tests/chikun-recording-ctx.mjs',
  'tests/chikun-sim-identity.test.mjs',
  'tests/chikun-lookahead-art.test.mjs',
  'tests/chikun-art-loader.test.mjs',
  'tests/chikun-light-rig.test.mjs',
...
const PY_COMPILE_FILES = [
  ...
  'scripts/build-chikun-art-pack.py',
  'scripts/build-chikun-review-plates.py',
  'scripts/chikun-blender/build-chikun-scenery.py',
  'scripts/chikun-blender/chikun_lib/__init__.py',
  'scripts/chikun-blender/chikun_lib/core.py',
  'scripts/chikun-blender/chikun_lib/periodic.py',
  'scripts/chikun-blender/chikun_lib/shading.py',
  'scripts/chikun-blender/chikun_lib/kit.py',
  'scripts/chikun-blender/regions/__init__.py',
  'scripts/chikun-blender/regions/common.py',
  'scripts/chikun-blender/regions/groundkit.py',
  'scripts/chikun-blender/regions/farmland.py',
  'scripts/chikun-blender/regions/forest.py',
  'scripts/chikun-blender/regions/town.py',
  'scripts/chikun-blender/regions/city.py',
  'scripts/chikun-blender/regions/industrial.py',
  'scripts/chikun-blender/regions/suburbs.py',
  'scripts/chikun-blender/regions/coast.py',
  'scripts/chikun-blender/regions/urbankit.py',
