...
const NODE_CHECK_FILES = [
  ...
  "tests/hmh-reboot-weapon-order-and-evolutions.test.mjs",
  "tests/hmh-reboot-foundations-determinism.test.mjs",
  "apps/hmh-reboot/src/boss-reference-dps.mjs",
  "scripts/hmh-progression-model.mjs",
  "tests/hmh-progression-model.test.mjs",
  ...
  "apps/hmh-reboot/src/mission-objectives.mjs",
  "apps/hmh-reboot/src/mission-guidance.mjs",
  "apps/hmh-reboot/src/mission-palette.mjs",
  "tests/hmh-mission-objectives.test.mjs",
  "tests/hmh-mission-placement.test.mjs",
  "tests/hmh-mission-palette.test.mjs",
  "tests/hmh-mission-guidance.test.mjs",
  "tests/hmh-mission-combat.test.mjs",
  "tests/hmh-mission-presentation.test.mjs",
  "tests/hmh-mission-determinism.test.mjs",
  "apps/hmh-reboot/src/boss-geometry.mjs",
  "apps/hmh-reboot/src/boss-arenas.mjs",
  "apps/hmh-reboot/src/boss-slots.mjs",
  "tests/hmh-boss-geometry.test.mjs",
  "tests/hmh-liquidator-walk-budget.test.mjs",
  "tests/hmh-boss-slots.test.mjs",
