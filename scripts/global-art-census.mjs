...
function runtimeRosterLayer(rosterReport) {
  ...
  return Object.freeze({
    ...
    sourcePolicy: 'Repo-owned runtime manifest for canonical actors; coverage judged by roster-coverage-report role matrix.',
    actorCount,
    assetCount: frameRefCount,
    policyCompliantAssetCount: frameRefCount,
    animationStateCount,
