...
// ok, version, settlementReady (a boolean only), paused, the relayer's public
...
// with degraded: true, never a 500. Cached at the edge for 30 s, and any query
// parameter is rejected (400 invalid-query), so the endpoint cannot be used to
// bypass the cache and load Neon or the RPC.
