...
6. **The bridge and portal bytes** (item 6): the 6.2 KB of HMH initial-JS cuts or a lazy load.
...
### 16.4 Red-team round (three attacks against `ff265ab8`, which the rebase onto `da3c0756` made `3003a565`)
...
### 16.6 Second red-team round (two attacks against `a9663a09`)
