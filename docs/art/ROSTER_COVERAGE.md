...
- Complete actors against the current role matrix: 35
- Partial actors: 3
...
| influencer-camera-drone | enemy | complete | attack, attack-tell, death, hit, idle, run, spawn-in, walk | none | none | idle:8d, walk:8d, run:8d, attack-tell:8d, attack:8d, hit:8d, death:8d, spawn-in:8d |
