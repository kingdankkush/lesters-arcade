...
> Player-facing numbers come from `apps/portal/src/ranked-fee.mjs` (the fee, re-exported by `arcade-core.mjs`) and `apps/portal/src/ranked-facts.mjs`; the player guide is https://lestersarcade.io/how-ranked-works.
