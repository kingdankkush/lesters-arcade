...
|---:|---|---|---|---|
| 1 | spawn / Broken Highway / Litecoin Bus Stop | 4,5 ±18 | Broken Highway / Litecoin Bus Stop: player should understand the immediate objective before enemy density rises If the player pauses here, the safe forward direction should be legible within 2 seconds | `street/bus-stop-sign`<br>`level-1/prop/desert-09`<br>`level-1/prop/desert-10`<br>`level-1/prop/dragon-bones-body-ground-shadow` |
| 2 | arena / Gas Station Forecourt Arena | 10,5 ±18 | Gas Station Forecourt Arena: player should understand the immediate objective before enemy density rises If the player pauses here, the safe forward direction should be legible within 2 seconds | `crypto/landmark-gas-station`<br>`level-1/prop/desert-09`<br>`level-1/prop/desert-10`<br>`level-1/prop/dragon-bones-body-ground-shadow` |
| 3 | arena / Ghost Town Main Street | 40,6 ±18 | Ghost Town Main Street: player should understand the immediate objective before enemy density rises If the player pauses here, the safe forward direction should be legible within 2 seconds | `crypto/ghost-saloon-front`<br>`level-1/building/ghost-boarded-storefront`<br>`level-1/building/ghost-saloon-front`<br>`level-1/prop/street-lamp` |
| 4 | loop / Farmstead Side Loop | 78,5 ±18 | Farmstead Side Loop: player should understand the immediate objective before enemy density rises If the player pauses here, the safe forward direction should be legible within 2 seconds | `construct/fence-gate`<br>`level-1/flora/broken-tree3`<br>`level-1/flora/burned-tree2`<br>`level-1/prop/orange-mushrooms1-ground-shadow` |
| 5 | chokepoint / River Bridge / Wash Crossing | 62,6 ±18 | River Bridge / Wash Crossing: player should understand the immediate objective before enemy density rises If the player pauses here, the safe forward direction should be legible within 2 seconds | `construct/wood-bridge`<br>`level-1/flora/broken-tree3`<br>`level-1/flora/burned-tree2`<br>`level-1/prop/orange-mushrooms1-ground-shadow` |
| 6 | pressure / Desert Boulder Road / Mesa Cut | 24,5 ±18 | Desert Boulder Road / Mesa Cut: player should understand the immediate objective before enemy density rises If the player pauses here, the safe forward direction should be legible within 2 seconds | `crypto/canyon-cliff-edge`<br>`level-1/prop/desert-09`<br>`level-1/prop/desert-10`<br>`level-1/prop/dragon-bones-body-ground-shadow` |
| 7 | boss / Second Town / Extraction Yard | 92,6 ±18 | Second Town / Extraction Yard: player should understand the immediate objective before enemy density rises If the player pauses here, the safe forward direction should be legible within 2 seconds | `level-final-setpiece/cohesive-boss-yard-gate`<br>`level-1/building/town-10`<br>`level-1/prop/park-bench`<br>`level-1/flora/oak-tree` |
| 8 | extract / Litecoin Extraction Pad | 98,5 ±18 | Litecoin Extraction Pad: player should understand the immediate objective before enemy density rises If the player pauses here, the safe forward direction should be legible within 2 seconds | `level-final-setpiece/cohesive-extraction-flare-road`<br>`level-1/building/town-10`<br>`level-1/prop/park-bench`<br>`level-1/flora/oak-tree` |
