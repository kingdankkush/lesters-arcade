...
- **Live facts** (read-only RPC at block 54396110 and `contracts/deployment-record.hardened.json`):
  ...
  - Entry is 0.1 zkLTC + 0.002 reserve = 0.102, split 85% developer / 15% arcade. The split does not change.
